...
const routes = [
    ...
    {
        path: 'create-meeting',
        loadChildren: () => __webpack_require__.e(/*! import() | create-meeting-create-meeting-module */ "create-meeting-create-meeting-module").then(__webpack_require__.bind(null, /*! ./create-meeting/create-meeting.module */ "./src/app/create-meeting/create-meeting.module.ts")).then(m => m.CreateMeetingPageModule)
    },
    {
        path: 'join-meeting',
        loadChildren: () => __webpack_require__.e(/*! import() | join-meeting-join-meeting-module */ "join-meeting-join-meeting-module").then(__webpack_require__.bind(null, /*! ./join-meeting/join-meeting.module */ "./src/app/join-meeting/join-meeting.module.ts")).then(m => m.JoinMeetingPageModule)
    },
    {
        path: 'schedule-meeting',
        loadChildren: () => __webpack_require__.e(/*! import() | schedule-meeting-schedule-meeting-module */ "schedule-meeting-schedule-meeting-module").then(__webpack_require__.bind(null, /*! ./schedule-meeting/schedule-meeting.module */ "./src/app/schedule-meeting/schedule-meeting.module.ts")).then(m => m.ScheduleMeetingPageModule)
    },
    {
        path: 'join-us',
        loadChildren: () => __webpack_require__.e(/*! import() | join-us-join-us-module */ "join-us-join-us-module").then(__webpack_require__.bind(null, /*! ./join-us/join-us.module */ "./src/app/join-us/join-us.module.ts")).then(m => m.JoinUsPageModule)
    },
    {
        path: 'session',
        loadChildren: () => __webpack_require__.e(/*! import() | session-session-module */ "session-session-module").then(__webpack_require__.bind(null, /*! ./session/session.module */ "./src/app/session/session.module.ts")).then(m => m.SessionPageModule)
    },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeetingSessionService", function() { return MeetingSessionService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let MeetingSessionService = class MeetingSessionService {
    constructor(platform, splashScreen, httpClient, androidPermissions) {
        this.platform = platform;
        this.splashScreen = splashScreen;
    ...
    joinSession(data_recv_server, obj, client_id) {
        ...
        this.session.on('signal:streamStatus', (event) => {
    ...
    getTokenCreate(name, meetingName, meetingCode, meetingDesc) {
    ...
    getTokenJoin(name, meetingId, meetingCode) {
    ...
    sendUserCtrl(connection_id, type, value) {
        if (this.participantList[connection_id]) {
            this.session.signal({
                data: type + "," + value,
...
MeetingSessionService.ctorParameters = () => [
...
MeetingSessionService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SessionPipe", function() { return SessionPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
SessionPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let UserVideoComponent = class UserVideoComponent {
    ...
    getNicknameTag() {
        try {
            ...
            this.nickname = JSON.parse(this.streamManager.stream.connection.data.split('%/%')[0]).clientData;
            // serverData = JSON.parse(this.streamManager.stream.connection.data.split('%/%')[1]).serverData;
        }
    }
};
...
UserVideoComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'user-video',
        template: `
...
module.exports = __webpack_require__(/*! /home/aputron/Desktop/Krishna/BKR_server/BKR/BKR_Mobile_App/src/main.ts */"./src/main.ts");
